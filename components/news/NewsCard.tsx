...
function NewsCard({ article }: { article: Article }) {
  ...
  return (
    <div className="p-4 h-full bg-zinc-900 border border-zinc-800 rounded-lg hover:border-violet-500/50 transition-all group">
      <div className="flex gap-4 ">
        {article.urlToImage && (
          <figure className="relative w-32 h-32 md:w-40 md:h-40 flex-shrink-0 overflow-hidden rounded-md bg-zinc-800">
            <Image
      ...
      {summary && (
        <div className="p-3 bg-violet-500/5 border-l-2 border-violet-500 rounded text-xs text-zinc-300 animate-in fade-in slide-in-from-top-2 mt-4">
